...
- My intention is then to leave the GitHub repo as is, so you can return and revisit and expand my code

- We will be working on instances setup by RStudio, so please go to [https://rstd.io/class](https://rstd.io/class)

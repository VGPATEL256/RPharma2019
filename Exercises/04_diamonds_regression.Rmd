...
You will find an Artifical Neural Network implemented in keras capable of predicting the price of a diamond: [here](https://github.com/leonjessen/RPharma2019/blob/master/R/04_diamonds_regression.R) (This script is also in the directory `/R` of your RStudio session)

---
title: "Exercise - Prototyping an Artificial Neural Network in R"
...
You will find a simple Artifical Neural Network implemented in base R [here](https://github.com/leonjessen/RPharma2019/blob/master/R/01_ann_prototype.R) (This script is also in the directory `/R` of your RStudio session)
...
Ok, so this was not particularly straight forward, it doesn't scale and writing complicated models this way would be challenging, to say the least. Let us see if there is a better way.

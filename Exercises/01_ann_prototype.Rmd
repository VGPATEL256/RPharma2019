...
You will find a simple Artifical Neural Network implemented in base R [here](https://github.com/leonjessen/RPharma2019/blob/master/R/ann_prototype.R) (This script is also in the directory `/R` of your RStudio session)

...
7. In the lower right pane (`Files`), you will now see all the workshop materials, i.e. files for talks and exercises
8. Locate and source the script `R/00_setup.R`, this will install all the nessesary libraries. _Note: When prompted for installing miniconda, just type `Y` and hit the return key_
